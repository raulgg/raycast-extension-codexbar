...
const MOCK_BUILDERS: Record<string, MockBuilder> = {
  ...
  atlascloud: buildGenericProvider("atlascloud"),
  bifrost: buildGenericProvider("bifrost"),
  coderabbit: buildGenericProvider("coderabbit"),
  devpass: buildGenericProvider("devpass"),
  gitkraken: buildGenericProvider("gitkraken"),
  helmcode: buildGenericProvider("helmcode"),
  huggingface: buildGenericProvider("huggingface"),
  hyper: buildGenericProvider("hyper"),
  llmman: buildGenericProvider("llmman"),
  muse: buildGenericProvider("muse"),
  nous: buildGenericProvider("nous"),
  pi: buildGenericProvider("pi"),
  replicate: buildGenericProvider("replicate"),
  typesafe: buildGenericProvider("typesafe"),
  v0: buildGenericProvider("v0"),
